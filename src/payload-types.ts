...
export interface CTASectionBlock {
   ...
   */
  background?: ('primary' | 'gradient' | 'dark' | 'light') | null;
  /**
   * Vertical padding and overall size of the CTA section
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CoreStackBlockProps".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "CoreStackBlockProps_select".
 */
export interface CoreStackBlockPropsSelect<T extends boolean = true> {
  title?: T;
  subtitle?: T;
  cards?:
    | T
